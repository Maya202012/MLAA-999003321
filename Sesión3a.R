...
lapply(banco, class)
#integer es entero número, character categórica
...
#obtenemos los valores de la densidad para cada punto en X, la d calcula donde cae exactamente 
valores <- dnorm(0.6, media, desviacion)
valores
