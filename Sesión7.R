...
summary (lm.cars)
plot (cars$dist ~cars$speed) #cuando usemos ~ poner primero y luego x  
?abline
abline (lm.cars) #para usarla primero se debe correr plot
...
#como se ve cuando no hay relación entre variables
